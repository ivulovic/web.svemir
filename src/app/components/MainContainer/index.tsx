...
export default function MainContainer({ children }): JSX.Element {
  return (
          ...
          <div className="video-stream">
            ...
            <div className="video-detail">
              <div className="video-content">
                ...
                {/* style="--delay: .3s" */}
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellendus illum tempora consequuntur. Lorem
                  ipsum dolor sit amet consectetur adipisicing elit. Debitis earum velit accusantium maiores qui sit
                  quas, laborum voluptatibus vero quidem tempore facilis voluptate tempora deserunt!{' '}
                </div>
                <div className="video-p-subtitle anim">
                {/* style="--delay: .4s" */}
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Temporibus laborum qui dolorum fugiat eius
                  accusantium repellendus illum tempora consequuntur. Lorem ipsum dolor, sit amet consectetur
                  adipisicing elit.
                </div>
              </div>
            </div>
